...
@section('title', 'BPJS Ketenagakerjaan - MPP Sukoharjo')
@section('meta_description', 'Halaman BPJS Ketenagakerjaan di MPP Kabupaten Sukoharjo')
  ...
  <section class="min-vh-100 d-flex align-items-center" style="background-color:#f4f5f7;">
    <div class="container py-5">
      ...
      <div class="text-center mb-4">
        <img src="assets/img/BPJS KETENAGAKERJAAN.png" alt="BPJS Ketenagakerjaan"
