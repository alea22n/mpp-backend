...
@section('title', 'Bank Bri- MPP Sukoharjo')
@section('meta_description', 'Halaman Bank Bri di MPP Kabupaten Sukoharjo')
        ...
        <section class="min-vh-100 d-flex align-items-center" style="background-color:#f4f5f7;">
            <div class="container py-5">
                ...
                <div class="text-center mb-4">
                    <img src="assets/img/BRI.png" alt="Bank Bri" style="max-width:200px;width:100%;height:auto;">
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-12 col-xl-10 mx-auto d-flex flex-column gap-3">
                        ...
                        <div class="d-flex align-items-center justify-content-between bg-body-secondary rounded-3 p-4">
                            <div class="d-flex align-items-start gap-3">
                                <div class="bg-danger text-white rounded-circle d-flex align-items-center justify-content-center"
                                     style="width:60px;height:60px;font-size:20px;">1</div>
                                <div>
                            ...
                            <button class="btn btn-info text-white px-4"
                                    onclick="window.open('assets/file/Persyaratan.pdf', '_blank')">
                                Persyaratan
                            </button>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between bg-body-secondary rounded-3 p-4">
                            <div class="d-flex align-items-start gap-3">
                                <div class="bg-danger text-white rounded-circle d-flex align-items-center justify-content-center"
                                     style="width:60px;height:60px;font-size:20px;">2</div>
                                <div>
                        ...
                        <div class="d-flex align-items-center justify-content-between bg-body-secondary rounded-3 p-4">
                            <div class="d-flex align-items-start gap-3">
                                <div class="bg-danger text-white rounded-circle d-flex align-items-center justify-content-center"
                                     style="width:60px;height:60px;font-size:20px;">3</div>
                                <div>
                    ...
                    <div class="row g-4 mt-3">
                        ...
                        <div class="col-lg-6">
                            <div class="card-red h-100">
                                ...
                                <a href="https://mpp.sragenkab.go.id" target="_blank"
