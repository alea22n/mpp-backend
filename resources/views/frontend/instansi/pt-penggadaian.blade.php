...
@section('title', 'PT Pegadaian - MPP Sukoharjo')
@section('meta_description', 'Halaman PT Pegadaian di MPP Kabupaten Sukoharjo')
    ...
    <section class="min-vh-100 d-flex align-items-center" style="background-color:#f4f5f7;">
        <div class="container py-5">
            ...
            <div class="text-center mb-4">
                <img src="assets/img/PEGADAIAN.png" alt="PT. Pegadaian" style="max-width:200px;width:100%;height:auto;">
            </div>
